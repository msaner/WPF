...
(clickPercentageA < clickPercentageB) ? console.log("Email B had a " + clickPercentageB + "%" + " click through rate. Use Email B for your campaign!") : console.log("Email A had a " + clickPercentageA + "%" + " click through rate.  Use Email A for your campaign!"); 
